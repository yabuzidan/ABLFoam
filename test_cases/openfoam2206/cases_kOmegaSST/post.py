...
omega_incident = pd.read_csv('postProcessing/samples_omega/'+endTime+'/incident_omega.csv')['omega']
omega_inlet    = pd.read_csv('postProcessing/samples_omega/'+endTime+'/inlet_omega.csv')['omega']
